#!/bin/bash
#SBATCH --job-name=svg_sft_v2
#SBATCH --output=/scratch/hk4488/SVG-Generation/logs/sft_v2_%j.log
#SBATCH --error=/scratch/hk4488/SVG-Generation/logs/sft_v2_%j.err
...
OUTPUT_DIR=/scratch/hk4488/SVG-Generation/outputs/svg_sft_v2
...
export WANDB_RUN_NAME="svg_sft_v2_r64_3ep_lr1e4"
