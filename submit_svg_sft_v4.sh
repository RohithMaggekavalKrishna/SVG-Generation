#!/bin/bash
#SBATCH --job-name=svg_sft_v4
#SBATCH --output=/scratch/hk4488/SVG-Generation/logs/sft_v4_%j.log
#SBATCH --error=/scratch/hk4488/SVG-Generation/logs/sft_v4_%j.err
...
CLEAN_CSV=/home/hk4488/SVG-Generation/data/train_v2.csv
OUTPUT_DIR=/scratch/hk4488/SVG-Generation/outputs/svg_sft_v4
LOG_DIR=/scratch/hk4488/SVG-Generation/logs

mkdir -p "$LOG_DIR" "$OUTPUT_DIR"
mkdir -p /scratch/hk4488/.cache/huggingface /scratch/hk4488/.cache/torch
...
export WANDB_RUN_NAME="svg_sft_v4_r64_3ep_resume"
...
# ── Train (resume from checkpoint-800 of the original run) ────────────────────
$PYTHON train_svg.py \
    --train-csv "$CLEAN_CSV" \
