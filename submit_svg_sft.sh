#!/bin/bash
#SBATCH --job-name=svg_sft
#SBATCH --output=/scratch/hk4488/SVG-Generation/logs/sft_%j.log
#SBATCH --error=/scratch/hk4488/SVG-Generation/logs/sft_%j.err
...
RAW_CSV=/home/hk4488/SVG-Generation/data/train.csv
CLEAN_CSV=/home/hk4488/SVG-Generation/data/train_clean.csv
OUTPUT_DIR=/scratch/hk4488/SVG-Generation/outputs/svg_sft
...
# ── Preprocess (skipped if clean CSV already exists) ───────────────────────────
if [ ! -f "$CLEAN_CSV" ]; then
    echo "Running preprocessing ..."
    $PYTHON preprocess.py --input "$RAW_CSV" --output "$CLEAN_CSV"
else
    echo "Clean CSV already exists, skipping preprocessing."
fi
